<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="header_footer.aspx.cs" Inherits="WebsiteThuCung.Header_Footer_Template.header_footer" %>
...
<head runat="server">
    ...
    <link href="../Header_Footer_Template/header_footer.css" rel="stylesheet" />
...
<body>
    <div class="header">
        <div class="top">
            <div class="brand">
                <a href="header_footer.aspx"><img alt="Ảnh thương hiệu" src="brand.jpg"/></a>
            </div>
            <div class="log">
                <a href="#"><i class="fa-solid fa-right-to-bracket"></i>Đăng nhập</a> |
                <a href="#"><i class="fa-solid fa-user-plus"></i>Đăng ký</a>
            </div>
        </div>
        <div class="nav">
            <ul>
               <li><a href="">DANH MỤC SẢN PHẨM</a>
                    <div class="dropdown">
                        <ul>
                            ...
                            <li><a href="dmtrangsuc.aspx">Trang sức</a></li>
                         </ul>
                    </div>
                </li>
